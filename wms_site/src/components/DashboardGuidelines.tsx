  ...
  <div className="dashboard-guidelines bg-white rounded-xl shadow p-6 max-w-md">
    ...
    <ol className="dashboard-guidelines__steps space-y-3 mb-4">
      <li className="flex items-start gap-2">
        <i className="fa-solid fa-barcode text-indigo-600 mt-1"></i>
        <div>
          <span className="font-semibold text-indigo-700">Шаг 1: Сканируйте продукт</span>
      ...
      <li className="flex items-start gap-2">
        <i className="fa-regular fa-file-lines text-indigo-600 mt-1"></i>
        <div>
          <span className="font-semibold text-indigo-700">Шаг 2: Опишите проблему</span>
          <div className="text-gray-600 text-sm">
      ...
      <li className="flex items-start gap-2">
        <i className="fa-regular fa-image text-indigo-600 mt-1"></i>
        <div>
          <span className="font-semibold text-indigo-700">Шаг 3: Приложите доказательства</span>
          <div className="text-gray-600 text-sm">
      ...
      <li className="flex items-start gap-2">
        <i className="fa-solid fa-paper-plane text-indigo-600 mt-1"></i>
        <div>
          <span className="font-semibold text-indigo-700">Шаг 4: Отправьте заявку</span>
          <div className="text-gray-600 text-sm">
    ...
    <a
      ...
      className="dashboard-guidelines__download bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-semibold px-4 py-2 rounded flex items-center gap-2"
    >
