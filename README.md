...
Скрипт гоняет случайные параметры и регистрации с «ломаными» ролями. Ожидаемые ответы — в основном `401/403/422`, но не `500`. Лог можно сохранить в файл и включить как иллюстрацию в записку.
